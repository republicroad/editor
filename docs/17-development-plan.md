...
- **第八十二批补（✅ 2026-09-13，方案一）**：undo 删节点语义闭环测试 3 用例（真实内核
  store 直驱：addNodes→removeNodes→undo→redo + 栈序/分支语义 + onChange 链路断言）。
...
- **第八十六批（✅ 2026-09-17）：内核 base-ui 迁移版 0.10.0 消费**——宿主 deps 升
