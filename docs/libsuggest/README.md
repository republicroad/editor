...
| S005 | 换肤布局槽位（P1 工具栏 0.6.0 / P2 right 面板 0.8.0 / P3 ShellHeader 0.9.0 全部 shipped） | 中     | done |
...
| S010 | zen-udf：`RosterScope` 类型从包索引导出（U5 租户化欠账；参数类型公开而类型面未公开，宿主结构化字面量绕行中） | 低 | proposed |
