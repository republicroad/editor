/**
 * 从 globalUdfRegistry 合并注册表导出自定义节点 schema 镜像，写入 packages/appshell/src/assets/custom-node-schema.json。
...
import { globalUdfRegistry } from '../jdm-editor/packages/zen-udf/src/index.ts';
